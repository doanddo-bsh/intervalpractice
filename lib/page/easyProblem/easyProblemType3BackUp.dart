...
class _EasyProblemType3State extends State<EasyProblemType3> {
  ...
  Widget secondeElevatedButton(String intervalName,String intervalNumber){
    return ElevatedButton(
        ...
        child: Text('$intervalName$intervalNumber도')
    );
  }
  ...
  Widget nextProblemResult(){
    return ElevatedButton(
        ...
        onPressed: (){
          ...
          if ((noteHeightListProblem[0][1]-noteHeightListProblem[1][1]).abs()==1){
            setState(() {
              downNoteLeft = 207.w;
            });
          } else if ((randomNoteNumber[0]-randomNoteNumber[1
  ...
  void initState() {
    ...
    if ((noteHeightListProblem[0][1]-noteHeightListProblem[1][1]).abs()==1){
      downNoteLeft = 207.w;
    } else if ((noteHeightListProblem[0][1]-noteHeightListProblem[1][1
    ]).abs()==0){
      downNoteLeft = 207.w;
    } else {
      downNoteLeft = 180.w;
